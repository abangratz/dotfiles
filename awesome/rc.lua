...
-- {{{ Tags
tags = {
   names  = { "browse", "edit", "av", "stuff", "spare",  "hangout", "music",  "out", "left" },
   layouts = { layouts[9], layouts[1], layouts[10], layouts[8], layouts[1], layouts[7], layouts[1], layouts[12], layouts[11] },
}
