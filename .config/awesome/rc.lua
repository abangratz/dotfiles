...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "3", "4", "5", "6", "7", "8", "9" }, s, {l.fair, l.tile, l.tile, l.tile, l.fair, l.fair, l.spiral, l.spiral, l.max})
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control"   }, "s", function () awful.spawn("deepin-screenshot") end,
...
-- awful.spawn.easy_async('workrave')
-- awful.spawn.easy_async('dockd --daemon')
awful.spawn.easy_async('systemctl start --user xscreensaver.service')
-- }}}
